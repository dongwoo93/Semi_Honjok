...
public class BoardWriteController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("저장된경로 : " + f.getAbsolutePath());*/
		...
		System.out.println("names while문 들어옴: " + names);
			...
			if(originalFileName != null) {
				...
				if(result > 0) {
					...
					if(fileResult > 0) {
						...
						System.out.println("썸네일 업로드 실패");
					}
				}else {
					System.out.println("데이터 업로드 실패");
				}
			}else {
				System.out.println("썸네일 이미지 null");
			}
