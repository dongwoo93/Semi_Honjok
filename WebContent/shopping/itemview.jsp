	...
	<div id="content" class="item-content">
		<div class="item-topinfowrap">
			...
			<div class="item-topinfo">
				<h1 class="itemtit">하루특가이벤트_대웅/보국 선풍기/리모컨선풍기</h1>
				<div class="prod_info">

					<p class="buy_num">
						구매 36,115<span class="remainder"></span>
					</p>
				...
				<div class="price_wrap">
					<div class="price">
						<span class="price_innerwrap"> <strong class="price_real">16,900<span
				...
				<div class="delivery-noti">
					...
					<div><img src="../images/order_tracking.png" width="55px" height="55px"></div>
				...
				<button id="ucShippingInfo_btnShippingInfoTitleText" class="nav" type="button">택배 - <em class="txt_emp">무료배송</em></button>
				</li>
				<li class="delivery_item  uxeslide_item">
				<button id="ucShippingInfo_btnShippingInfoTitleText" class="nav" type="button">포인트 <em class="txt_emp">최대 1.5% 적립</em></button>
				</li>
				<li class="delivery_item  uxeslide_item">
				<button id="ucShippingInfo_btnShippingInfoTitleText" class="nav" type="button">원산지 - <em class="txt_emp">중국</em></button>
				</li>
				</ul>
