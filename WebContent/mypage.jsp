...
<link href="https://fonts.googleapis.com/css?family=Baloo:400"
	rel="stylesheet">
<link
...
.is-builder .nodisplay+img[async], .is-builder .nodisplay+img[decoding="async"],
...
@media ( max-width : 768px) {
	...
	.display-2 {
		...
		line-height: calc(1.4 * ( 1.42rem + ( 2.2 - 1.42)* ((100vw- 20rem)/(48-
			 20))));
	}
	.display-4 {
		font-size: 0.72rem;
		font-size: calc(0.965rem + ( 0.9 - 0.965)* ((100vw- 20rem)/(48- 20)));
		line-height: calc(1.4 * ( 0.965rem + ( 0.9 - 0.965)* ((100vw- 20rem)/(48-
	...
	.display-5 {
		...
		line-height: calc(1.4 * ( 1.28rem + ( 1.8 - 1.28)* ((100vw- 20rem)/(48-
			 20))));
	}
}
...
.cid-qWeO0w2cHm .mbr-title {
	padding-bottom: 1rem;
}

.cid-qWeO0w2cHm .mbr-section-btn {
	padding-top: 1.5rem;
}
...
.cid-qWeNZIr2IE .mbr-title {
	padding-bottom: 1rem;
}

.cid-qWeNZIr2IE .mbr-section-btn {
	padding-top: 1.5rem;
}
...
.cid-qWeNYqXqYP .card .btn {
	margin: .4rem 4px;
}

.cid-qWeNYqXqYP .card-title {
	margin: 0;
	text-align: left;
}

.cid-qWeNYqXqYP .mbr-text {
	color: #232323;
}

.cid-qWeNYqXqYP .card-box {
	padding-top: 2rem;
}

.cid-qWeNYqXqYP amp-img {
	width: 100%;
}
...
.cid-qWeUjjZ3Ts .mbr-row {
	flex-direction: row-reverse;
}

.cid-qWeUjjZ3Ts .btn-container {
	display: flex;
	align-items: center;
	justify-content: center;
}
...
@media ( min-width : 768px) {
	.cid-qWeUjjZ3Ts .mbr-section-subtitle {
		margin-bottom: 0;
	}
}
...
<body>
	<section class="mbr-section content18 cid-qWeO0w2cHm" id="content18-5">
	...
	<section class="engine">
		<a href="https://mobiri.se/a">online web builder</a>
	</section>
	<section class="mbr-section content1 cid-qWeNZIr2IE" id="content1-4">
	...
	<section class="features2 mbr-section cid-qWeNYqXqYP" id="features2-3">
			...
			<div class="mbr-row mbr-justify-content-center">
				<div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
					<div class="card-wrapper">
						...
						<div class="card-box">
							<h4
								class="card-title mbr-fonts-style align-left mbr-light display-5">
								내정보</h4>
				...
				<div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
					<div class="card-wrapper">
						...
						<div class="card-box">
							<h4
								class="card-title mbr-fonts-style align-left mbr-light display-5">회원정보수정</h4>
							<p class="mbr-text mbr-fonts-style align-left display-4">
								회원님의 개인정보를 관리하며<br>수정 할 수 &nbsp;있습니다.<br> <br>
							</p>
							<div class="mbr-section-btn align-left">
								<a class="btn btn-sm btn-black display-4"
				...
				<div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
					<div class="card-wrapper">
						...
						<div class="card-box">
							<h4
								class="card-title mbr-fonts-style align-left mbr-light display-5">회원탈퇴</h4>
							<p class="mbr-text mbr-fonts-style align-left display-4">
								회원님의 사이트 탈퇴를 할&nbsp;<br>수 있습니다.<br> <br>
							</p>
							<div class="mbr-section-btn align-left">
								<a class="btn btn-sm btn-black display-4"
				...
				<div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 last-child">
					<div class="card-wrapper">
						...
						<div class="card-box">
							<h4
								class="card-title mbr-fonts-style align-left mbr-light display-5">게시물관리</h4>
							<p class="mbr-text mbr-fonts-style align-left display-4">
	...
	<section class="info2 cid-qWeUjjZ3Ts" id="info2-9">



		<div class="container">
			<div class="mbr-row mbr-justify-content-center"></div>
		</div>
	</section>

	<section class="footer1 cid-qWeOhNNSCG" id="footer1-7">
