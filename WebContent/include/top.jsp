...
<body>
	...
	<ul class="nav navbar-nav">
		<li class="dropdown"><a id="hontalkView" href="hontalkView.freeb" class="catego nav-link">혼톡</a>
		...
		<li class="dropdown"><a	id="tip" href="selectNaviCat.tip?category=꿀팁" class="catego nav-link">꿀팁</a>
			<ul class="dropdown-menu">
		...
		<li class="dropdown nav-item"><a id="cook"
			...
			<ul class="dropdown-menu">
				<li class="dropdown-item"><a
					href="selectNaviSub.tip?category=요리&subject=초간단 요리">초간단 요리</a></li>
				<li class="dropdown-item"><a
					href="selectNaviSub.tip?category=요리&subject=일반 요리">일반 요리</a></li>
			</ul></li>


		<li class="dropdown"><a id="interior" href="selectNaviCat.tip?category=인테리어" class="catego nav-link">인테리어</a>
			<ul class="dropdown-menu">
				<li class="dropdown-item"><a
		...
		<li class="dropdown"><a id="travel"href="selectNaviCat.tip?category=혼족여행" class="catego nav-link">혼족여행</a>
			<ul class="dropdown-menu">
				<li class="dropdown-item"><a
		...
		<li class="dropdown"><a id="famous" href="selectNaviCat.tip?category=혼족맛집" class="catego nav-link">혼족맛집</a>
			<ul class="dropdown-menu">
				<li class="dropdown-item"><a
		...
		<li class="dropdown"><a id="shopping" href="selectNaviCat.tip?category=혼족쇼핑" class="catego nav-link">혼족쇼핑</a>
			<ul class="dropdown-menu">
				<li class="dropdown-item"><a
