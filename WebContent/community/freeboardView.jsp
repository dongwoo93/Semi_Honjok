...
<%@page import="honjok.web.dao.BoardFreeDTO"%>
<jsp:useBean id="dto" class="honjok.web.dao.BoardFreeDTO">
				...
				<c:forEach var="item" items="${result}">
					<tbody id="body_a">
						<tr>
							...
							<td id="title"><a href="ArticleController?no=${item.seq}" class="no-uline">${item.title}</a>
